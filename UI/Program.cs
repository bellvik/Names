...
public static class Program
{
	...
	public static void ShowPlots()
	{
        ...
        //Charts.ShowHistogram(HistogramTask.GetBirthsPerDayHistogram(namesData, "татьяна"),"Рождаемость людей с именем Татьяна");
        Charts.ShowLineSeries(LineSeriesTask.GetLineData(namesData, "татьяна"), "Рождаемость людей с именем Татьяна");
